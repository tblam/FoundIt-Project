...
function init () { 
    ...
    $.get("getData.php", function(data){     
        ...
        //Collect addresses
        for(count in data)
            addresses.push(data[count].address);  

        console.log("Total school displayed: " + addresses.length);  
...
function geoCode(addr) {    
    ...
    if (status == google.maps.GeocoderStatus.OK){     
        ...
        //Import to database
        var url = "import_database.php?lat=" + lat + "&lng=" + lng + "&street=" + street + "&city=" + city + "&county=" + county + "&zip=" + zip + "&addr=" + addr;
